import{_ as o,c,b as i,w as a,a as t,r as l,o as p,d as n,e}from"./app.090aa1b4.js";const x='{"title":"Home","description":"","frontmatter":{"home":true,"actionText":"User Guide \u2192","actionLink":"/guide/","features":[{"title":"OpenAPI conformant","details":"Generate OpenAPI documents in version 3.0 or 3.1."},{"title":"Document your API inside PHP source code","details":"Using swagger-php lets you write the API documentation inside the PHP source files which helps keeping the documentation up-to-date."},{"title":"Annotation and Attribute support","details":"Annotations can be either docblocks or PHP 8.1 attributes."}]},"headers":[{"level":3,"title":"1. Install with composer:","slug":"_1-install-with-composer"},{"level":3,"title":"2. Update your code","slug":"_2-update-your-code"},{"level":3,"title":"3. Generate OpenAPI documentation","slug":"_3-generate-openapi-documentation"},{"level":3,"title":"4. Explore and interact with your API","slug":"_4-explore-and-interact-with-your-api"},{"level":2,"title":"Links","slug":"links"}],"relativePath":"index.md"}',r={},u=t(`<h3 id="_1-install-with-composer" tabindex="-1">1. Install with composer: <a class="header-anchor" href="#_1-install-with-composer" aria-hidden="true">#</a></h3><div class="language-shell"><pre><code><span class="token operator">&gt;</span> <span class="token function">composer</span> require zircote/swagger-php
 ...
 * )
 */`),e(`
`),n("span",{class:"token keyword"},"class"),e(),n("span",{class:"token class-name-definition class-name"},"OpenApi"),e(),n("span",{class:"token punctuation"},"{"),n("span",{class:"token punctuation"},"}"),e(`

`),n("span",{class:"token keyword"},"class"),e(),n("span",{class:"token class-name-definition class-name"},"MyController"),e(),n("span",{class:"token punctuation"},"{"),e(`
     ...
     * )
     */`),e(`
    `),n("span",{class:"token keyword"},"public"),e(),n("span",{class:"token keyword"},"function"),e(),n("span",{class:"token function-definition function"},"getResource"),n("span",{class:"token punctuation"},"("),n("span",{class:"token punctuation"},")"),e(),n("span",{class:"token punctuation"},"{"),e(`
...
`),n("span",{class:"token keyword"},"class"),e(),n("span",{class:"token class-name-definition class-name"},"MyController"),e(),n("span",{class:"token punctuation"},"{"),e(`
    ...
    `),n("span",{class:"token punctuation"},"}"),e(`
`),n("span",{class:"token punctuation"},"}"),e(`
`)])])])],-1),h=t(`<h3 id="_3-generate-openapi-documentation" tabindex="-1">3. Generate OpenAPI documentation <a class="header-anchor" href="#_3-generate-openapi-documentation" aria-hidden="true">#</a></h3><div class="language-shell"><pre><code><span class="token operator">&gt;</span> ./bin/openapi src -o openapi.yaml
</code></pre></div><h3 id="_4-explore-and-interact-with-your-api" tabindex="-1">4. Explore and interact with your API <a class="header-anchor" href="#_4-explore-and-interact-with-your-api" aria-hidden="true">#</a></h3><p>Use an OpenAPI tool like <a href="https://swagger.io/tools/swagger-ui/" target="_blank" rel="noopener noreferrer">Swagger UI </a> to explore and interact with your API.</p><h2 id="links" tabindex="-1">Links <a class="header-anchor" href="#links" aria-hidden="true">#</a></h2><ul><li><a href="./guide/">User Guide</a></li><li><a href="./reference/">Reference</a></li><li><a href="https://oai.github.io/Documentation/" target="_blank" rel="noopener noreferrer">OpenApi Documentation</a></li><li><a href="https://spec.openapis.org/oas/v3.1.0.html" target="_blank" rel="noopener noreferrer">OpenApi Specification</a></li><li><a href="https://github.com/zircote/swagger-php/tree/master/Examples" target="_blank" rel="noopener noreferrer">Learn by example</a></li><li><a href="./related-projects.html">Related projects</a></li><li><a href="https://github.com/zircote/swagger-php/tree/2.x/docs" target="_blank" rel="noopener noreferrer">Swagger-php 2.x documentation</a></li></ul>`,6);function m(g,_,f,b,A,w){const s=l("codeblock");return p(),c("div",null,[u,i(s,{id:"minimal"},{an:a(()=>[d]),at:a(()=>[k]),_:1}),h])}var P=o(r,[["render",m]]);export{x as __pageData,P as default};
